...
if 'airline_sentiment' in tweets.columns and 'airline' in tweets.columns:
    ...
    ax.set_title('Count of Airline Sentiments', fontsize=14)
    ...
    ax3.set_title('Tweet Counts by Airline', fontsize=14)
    ax3.set_xlabel('Airline', fontsize=12)
    ...
    st.error("Required columns 'airline_sentiment' and 'airline' not found in the dataset.")
